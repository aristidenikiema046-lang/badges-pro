...
<div class="badge-fixed-container relative bg-white flex flex-col items-center overflow-hidden w-full h-full border border-gray-100">
    ...
    {{-- 1. Logo de l'entreprise (un peu plus compact) --}}
    ...
    <div class="flex-grow flex flex-col items-center justify-center w-full px-4 text-center">
        ...
        <div class="mb-2">
            <h1 class="text-xl font-black uppercase leading-tight text-gray-900">
                {{ $employee->last_name }}
            </h1>
        ...
        <div class="space-y-0.5">
            <p class="text-[11px] font-extrabold text-gray-700 uppercase tracking-tight">
                {{ $employee->function }}
            </p>
