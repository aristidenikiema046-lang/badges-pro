@php 
    ...
    // 1. Logique de masquage : masque le nom si le logo est personnalisé (dossier 'logos_entreprises')
    $isCustomLogo = $employee->company->logo && str_contains($employee->company->logo, 'logos_entreprises');
    
    // 2. Nettoyage pour éviter l'erreur ISO-8859-1 du QR Code
...
<head>
    ...
    <style>
        ...
        .circuit-pattern {
            ...
            /* Correction du commentaire CSS ici */
